...
import type { MenuDivider, MenuItem, MenuSwitch } from '@/types/menu.js';
			...
			},
			{
				...
				children: async () => {
					...
					return lists.map(list => {
						const isListed = ref(list.userIds !== undefined && list.userIds.includes(user.id));
