...
<div class="_gaps">
	...
	<MkSelect v-model="rolePermission" :readonly="readonly">
		...
		<template #caption><div style="white-space: pre-wrap;" v-text="i18n.ts._role.descriptionOfPermission.replace(/<\/?b>/g, '')"></div></template>
	...
	<MkSelect v-model="role.target" :readonly="readonly">
		...
		<template #caption><div style="white-space: pre-wrap;" v-text="i18n.ts._role.descriptionOfAssignTarget.replace(/<\/?b>/g, '')"></div></template>
