...
<div class="_gaps">
	...
	<MkSelect v-model="rolePermission" :readonly="readonly">
		...
		<template #caption><div v-text="i18n.ts._role.descriptionOfPermission.replace(/<\/?b>/g, '')" style="white-space: pre-wrap;"></div></template>
	...
	<MkSelect v-model="role.target" :readonly="readonly">
		...
		<template #caption><div v-text="i18n.ts._role.descriptionOfAssignTarget.replace(/<\/?b>/g, '')" style="white-space: pre-wrap;"></div></template>
