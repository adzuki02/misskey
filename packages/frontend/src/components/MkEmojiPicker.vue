	...
	<div ref="emojisEl" class="emojis" tabindex="-1">
		<section class="result">
			<div v-if="searchResultCustom.length > 0" class="body">
				...
				>
					<MkCustomEmoji class="emoji" :name="emoji.name" :fallbackToImage="true" :forceAnimation="defaultStore.reactiveState.forceAnimatedImagesOnPopup.value"/>
				</button>
			</div>
			...
			<section v-if="showPinned && (pinned && pinned.length > 0)">
				<div class="body">
					<button
						...
						@click="chosen(emoji, $event)"
					>
						<MkCustomEmoji v-if="!emoji.hasOwnProperty('char')" class="emoji" :name="getKey(emoji)" :normal="true" :forceAnimation="defaultStore.reactiveState.forceAnimatedImagesOnPopup.value"/>
